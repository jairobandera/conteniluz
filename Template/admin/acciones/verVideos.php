...
if(isset($_GET['id_curso']) and isset($_GET['id_empresa']) and isset($_GET['id_profesor'])){
	...
	$resultado = $conectado->query("SELECT * FROM videos WHERE id_curso = $id_curso AND id_empresa = $id_empresa AND id_profesor = $id_profesor");
			...
			<div class="vlt-content-holder">
					...
					<div class="container">
						<div class="vlt-header-inner">
							<div class="vlt-header-left">
								<a href="verCursos.php?id_empresa=<?php echo $id_empresa ?>" class="vlt-site-logo">
				...
				<div class="vlt-navigation-fullscreen-holder">
					<div class="vlt-navigation-fullscreen">
						<ul>
							<li><a href="verCursos.php?id_empresa=<?php echo $id_empresa ?>">Volver</a></li>
						</ul>
